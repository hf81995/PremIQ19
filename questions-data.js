...
const QUESTIONS = [
  ...
  { id:4, short:'Number of 0-0 draws', type:'numeric-single', points:30, unit:'draws',
  ...
  { id:5, short:'Managers no longer in post', type:'numeric-single', points:25, unit:'managers',
