...
const MONTH_ORDER = ['August','September','October','November','December'];
function sortByMonth(fixtures){
  return [...fixtures].sort((a,b) => MONTH_ORDER.indexOf(a.month) - MONTH_ORDER.indexOf(b.month));
}
...
const QUESTIONS = [
  ...
  { id:3, short:'Quickest goal (seconds)', type:'numeric-tiered', points:{closest:100, nextNearest:50}, unit:'seconds',
    label: 'Question 3: Quickest goal (in seconds) in the 19 Matchweeks (first meetings only).',
  ...
  { id:4, short:'Number of 0-0 draws', type:'numeric-single', points:30, unit:'nil-nil draws',
    label: 'Question 4: How many 0-0 draws will there be in the 19 Matchweeks (first meetings only)?',
  ...
  { id:5, short:'3+ managers sacked by 1 Jan?', type:'yesno', points:25,
    label: 'Question 5: Will 3+ managers be sacked by January 1st? Yes or No?',
    hint: 'Last season 6 managers were sacked in the first half of the season (up to 6 January): Nuno, Potter, Postecoglou, Pereira, Maresca, Amorim.',
    pointsText: '25 Points if Correct' },
  ...
  { id:7, short:'Newcastle or Sunderland — more wins', type:'twochoice', points:25, optionA:'Newcastle United', optionB:'Sunderland', void:true,
    label: 'Question 7: Newcastle or Sunderland to win more of their 19 Matchweeks (first meetings only) (Void if tied.)',
    pointsText: '25 points' },
  { id:8, short:'Haaland hat-trick?', type:'yesno', points:25,
    label: "Question 8: Will Haaland score a hat-trick in Man City's 19 Matchweeks (first meetings only)",
    hint: "He didn't score one at all in the 25/26 Premier League season.",
    pointsText: '25 points' },
  { id:9, short:'Other hat-trick scorer', type:'text', points:50,
    label: 'Question 9: Type any player (other than Haaland) to score a hat-trick in 19 Matchweeks (first meetings only).',
  ...
  { id:10, short:'Golden Boot leader beats 20th\'s total?', type:'yesno', points:25,
    label: "Question 10: Will the Premier League's highest goal scorer have scored more than the whole team in 20th place, as of 19 Matchweeks (first meetings only).",
    hint: 'Last season (whole season) Haaland scored 27 and Wolves scored 27.',
    pointsText: '25 points' },
  { id:11, short:'Goalkeeper assist?', type:'yesno', yesPoints:100, noPoints:25,
    label: 'Question 11: Will any goalkeeper register an assist across 19 Matchweeks (first meetings only).',
  ...
  { id:12, short:'Goalkeeper with 8 clean sheets?', type:'yesno', points:25,
    label: 'Question 12: Will any goalkeeper keep 8 clean sheets in 19 Matchweeks (first meetings only)',
    hint: 'David Raya kept 19 clean sheets across the whole 38 games last season.',
    pointsText: '25 points' },
  { id:13, short:'A team with 4 red cards?', type:'yesno', points:25,
    label: 'Question 13: Will any team rack up 4 red cards (players only) during 19 Matchweeks (first meetings only)',
    hint: 'The most red cards last season (whole season) was Chelsea with 8.',
    pointsText: '25 points' },
  { id:14, short:'Rice or Bruno G — first to score', type:'twochoice', points:25, optionA:'Declan Rice', optionB:'Bruno Guimar\u00e3es', void:true,
    label: 'Question 14: Who will score first for Arsenal in the league between Declan Rice or Bruno Guimar\u00e3es? (Void if neither scores during 19 Matchweeks first meetings only.)',
    hint: 'For the whole of 25/26, Bruno G scored 9 for Newcastle (including 2 penalties). Rice scored 4.',
    pointsText: '25 points' },
  { id:15, short:'Bruno Fernandes 8+ assists?', type:'yesno', points:25,
    label: "Question 15: Will Bruno Fernandes reach 8+ assists across Man United's 19 Matchweeks (first meetings only)",
    hint: 'Bruno had a record 21 assists across the whole 25/26 season.',
    pointsText: '25 points' },
  { id:16, short:'Team to win 5 in a row', type:'teamselect', points:50,
    ...
    pointsText: '50 points' },
  { id:17, short:'Palmer AND Morgan Rogers both 4+ goals?', type:'yesno', points:25,
    label: 'Question 17: Chelsea boys! Will Cole Palmer and Morgan Rogers both score 4+ goals across Chelsea\u2019s 19 Matchweeks (first meetings only)',
    hint: 'Both scored 10 goals each across the whole 25/26 season.',
    pointsText: '25 points' },
  { id:18, short:'Bournemouth 11th or better?', type:'yesno', points:25,
    label: 'Question 18: Will Bournemouth be in 11th place or better across 19 Matchweeks (first meetings only)',
    hint: 'Bournemouth finished the 25/26 season in 6th.',
    pointsText: '25 points' },
  { id:19, short:'Harry Wilson\'s first goal — in/out the box', type:'twochoice', optionA:'Outside the box', optionB:'Inside the box', aPoints:50, bPoints:25, void:true,
    label: "Question 19: Will Harry Wilson's first League goal for Leeds be inside or outside the box? (across 19 fixtures, first meetings only) (Void if he doesn't score at all.)",
